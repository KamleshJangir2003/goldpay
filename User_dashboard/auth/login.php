    ...
    <div class="right-section">
        ...
        <?php if ($is_mobile && !$apk_downloaded): ?>
            ...
            <div style="text-align:center;padding:20px 0;">
                ...
                <a href="../../app-debug.apk.zip" download="Goldpay.apk.zip" onclick="setTimeout(function(){ window.location='login.php?apk_downloaded=1'; }, 3000);" class="btn btn-primary" style="display:inline-block;text-decoration:none;padding:16px 32px;width:auto;">
