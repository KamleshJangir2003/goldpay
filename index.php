    ...
    function translateToHindi() {
      try {
        setMultipleText([
          ...
          { selector: '.copyright', text: '© 2026 Goldpay. सर्वाधिकार सुरक्षित।' },
        ]);
        ...
        if (faqQ.length >= 4 && faqA.length >= 4) {
          faqQ[0].textContent = 'Goldpay क्या है?';
          faqA[0].textContent = 'Goldpay INR के साथ USDT को तुरंत खरीदने और बेचने का प्लेटफॉर्म है।';
    ...
    function translateToEnglish() {
      try {
        setMultipleText([
          ...
          { selector: '.copyright', text: '© 2026 Goldpay. All Rights Reserved.' },
        ]);
